...
class walker_texas_ranger extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_classes = array(
            ...
            'depth_class'           => $depth >= 1 ? $this->item_css_classes['sub_menu_item'] : '',
        );
        ...
        // link attributes
        $attributes  = ' class="' . $this->item_css_classes['link'] . '"';
...
function bem_menu( $location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null, $depth = 2 ) {
